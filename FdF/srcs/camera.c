...
/*   Updated: 2023/08/22 14:15:35 by geshin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	camera->position = make_vec3(10.0, 10.0, 10.0);
	camera->front = make_vec3(0.0, -1.0, 0.0);
...
void	update_rotation_state(t_camera* camera)
{
	...
	camera->right = cross_product(camera->front, camera->worldUp);
