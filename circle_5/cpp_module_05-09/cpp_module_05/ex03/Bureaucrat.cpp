...
/*   Updated: 2024/01/17 14:57:59 by singeonho        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Bureaucrat::Bureaucrat()
	: m_Name("Default"), m_Grade(Bureaucrat::s_MinGrade)
{
	//__noop;
}
...
{
	if (m_Grade < Bureaucrat::s_MaxGrade)
		throw(Bureaucrat::GradeTooHighException());
	if (m_Grade > Bureaucrat::s_MinGrade)
...
void Bureaucrat::executeForm(const AForm& form)
{
	...
	{
		std::cerr << m_Name << " couldn't execute " << form.getName() << " because " << e.what() << std::endl;
	}
}
